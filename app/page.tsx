          ...
          <div className="text-balance text-center">
            <div className="flex flex-col gap-2 md:gap-4">
              ...
              <h3 className="text-fg-tertiary font-light leading-snug sm:leading-normal sm:text-lg lg:text-xl">
                With a specialization in full-stack web development using
                Next.js, React and Express and expertise in TypeScript, Tailwind
                CSS, modern database practices and CI/CD, I build and deploy
